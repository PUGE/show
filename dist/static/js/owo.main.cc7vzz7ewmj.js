// Thu Oct 31 2019 13:39:36 GMT+0800 (GMT+08:00)
...
owo.script = {
    ...
    "template": {
      "line": {
        "prop": {
          ...
          "name": "line",
          "text": "文字字体",
          "src": "./src/module/button/line.owo"
        }
      },
      "line-1": {
        "prop": {
    ...
    "template": {
      ...
      "colorLine": {
        "prop": {
          ...
          "name": "colorLine",
          "text": "边框按钮",
          "src": "./src/module/button/colorLine.owo"
        }
      },
      "color": {
        "prop": {
      ...
      "waterRipple": {
        ...
        "prop": {
          ...
          "name": "waterRipple",
          "text": "水波纹特效",
          "src": "./src/module/waterRipple.owo"
        }
      }
    }
  },
    ...
    "template": {
      ...
      "flip": {
        ...
        "prop": {
          "name": "flip",
          "direction": "x",
          "src": "./src/module/swiper/flip.owo"
        }
      },
      "flip-1": {
        "data": {
  ...
  "enter": {
    ...
    "animate": function animate(name) {
      copyText("owo.tool.animate(\"" + name + "\", owo.query('dom')[0])", 0);
